...
dataset_names = ["foresttype", "http", "annthyroid", "cardio", "ionosphere", "mammography", "satellite", "shuttle",
                 "thyroid", "smtp",
...
for dataset_name in dataset_names:
    ...
    for dataset_type in dataset_types:
        ...
        if dataset_type in ["10BIN", "15BIN"]:
            precision_pse = calculate_PrecisionAtK_chord(filename=dataset_name, dataset_type=dataset_type,
                                                         algo_type="log_pseudolikelihood", k=k)
...
pd_eif_result.to_excel("./EIF_SIF_Result/Precision_at_K_AnomalyRate_IR_EIF_SIF_ensemble_more.xlsx")
